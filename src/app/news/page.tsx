...
export default function NewsPage({ searchParams }: { searchParams: { page?: string; type?: string } }) {
  ...
  const articles = getPublishedArticles(pageSize, offset, undefined, undefined, articleType);
