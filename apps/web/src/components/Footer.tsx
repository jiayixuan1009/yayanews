        ...
        <div className="grid gap-10 pt-8 sm:pt-10 lg:grid-cols-[1.1fr,0.8fr,0.8fr,0.8fr]">
          <div>
            ...
            <div className="mt-6 flex flex-wrap items-center gap-4 yn-footer-body text-emerald-50/82">
              <OutboundLink href={siteConfig.parentSite} label="mainsite_cta" source="footer" className="hover:text-white">{dict.officialSite || 'Official Website'}</OutboundLink>
              <OutboundLink href={siteConfig.tradingSite} label="trading_cta" source="footer" className="hover:text-white">{dict.tradingSite || 'Trading'}</OutboundLink>
              <LocalizedLink href="/topics" className="hover:text-white">{dict.topicsLink || 'Topics'}</LocalizedLink>
              <a href={siteConfig.socialLinks.telegram} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 hover:text-white">
              ...
              <a href={siteConfig.socialLinks.twitter} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 hover:text-white">
